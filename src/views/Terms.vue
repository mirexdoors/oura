<template functional>
    <div class="about">
        ...
        <p>
            These terms and conditions outline the rules and regulations for the use of Healthboard's Website, located
            at https://healthboard.tech/.
        </p>

        <p>
            By accessing this website we assume you accept these terms and conditions. Do not continue to use
            healthboard.tech if you do not agree to take all of the terms and conditions stated on this page
        </p>
        <p>
            ...
            in the most appropriate manner for the express purpose of meeting the Client’s needs in respect of the
            provision of the Company’s stated services, in accordance with and subject to, prevailing law of Russia. Any
         ...
         <h2>Cookies</h2>
        <p>
            We employ the use of cookies. By accessing healthboard.tech, you agreed to use cookies in agreement with the
            Healthboard's Privacy Policy.
        </p>
        ...
        <p>
         ...
         <h2>License</h2>
        <p>
            Unless otherwise stated, Healthboard and/or its licensors own the intellectual property rights for all
            material on healthboard.tech. All intellectual property rights are reserved. You may access this from
            healthboard.tech for your own personal use subjected to restrictions set in these terms and conditions.
        </p>
        ...
        <ul>
            <li>Sell, rent or sub-license material from healthboard.tech</li>
            <li>Reproduce, duplicate or copy material from healthboard.tech</li>
        </ul>
        <p>This Agreement shall begin on the date hereof.</p>

         <h2>Hyperlinking to our Content</h2>
        <p>You may link to our Website without prior approval.</p>
        ...
        <p>We shall not be held responsible for any content that appears on your Website. You agree to protect and
            ...
            may be interpreted as libellous, obscene or criminal, or which infringes, otherwise violates, or advocates
            the infringement or other violation of, any third party rights</p>

         <h2>Your Privacy</h2>
        <p>Please read <a href="/privacy" target="_blank" rel="noopener noreferrer">Privacy Policy</a></p>
        ...
        <p>If you find any link on our Website that is offensive for any reason, you are free to contact and inform us
            at any moment. We will consider requests to remove links but we are not obligated to or so or to respond to
            you directly.</p>
        <p>
