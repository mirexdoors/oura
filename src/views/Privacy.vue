<template functional>
    <div class="text_block">
        ...
        <p>Last updated: September 03, 2020
        </p>
        ...
        <ul>
            ...
            <li>Website refers to Healthboard, accessible from healthboard.com</li>
        ...
        <ul>
            <li>Email address</li>
            <li>Usage Data</li>
            <li>Oura.cloud data (sleep, readiness, activity parameters)</li>
        </ul>
        <h4>Usage Data</h4>
        ...
        <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on your personal computer or
            ...
            Learn more about cookies: What Are Cookies?</p>
        ...
        <ul>
            ...
            <li>To contact You: To contact You by email regarding updates or informative communications related to the
        ...
        <p>We do not share your personal information. Your oura.cloud data may be used for calculations of mean
            parameters between all users.</p>
        ...
        <h2>Your California Privacy Rights (California's Shine the Light law)
        </h2>
        ...
        <h2>California Privacy Rights for Minor Users (California Business and Professions Code Section 22581)
        </h2>
        ...
        <p>If you have any questions about this Privacy Policy, You can contact us by email: <a target="_blank"
                                                                                                rel="noopener noreferrer"
                                                                                                href="mailto:feedback@healthboard.tech">feedback@healthboard.tech</a>
        </p>
    </div>
</template>
